...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Ben Suskins"
    user-mail-address "suskinsdevelopment@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/bensuskins/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/bensuskins/bin" "/profile/bin" "/Users/bensuskins/.npm-packages/bin" "/Users/bensuskins/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
